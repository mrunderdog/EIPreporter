...
function renderDashboardV3Styles(): string {
  return `
    ...
    .dash-legend{display:flex;gap:14px;margin-bottom:12px;color:var(--dash-text-secondary);font-size:12px}.dash-legend span{display:flex;gap:6px;align-items:center}.dash-spec-dot,.dash-discussion-dot{width:9px;height:9px;border-radius:999px;background:var(--dash-spec)}.dash-discussion-dot{background:var(--dash-discussion)}.dash-domain-row{width:100%;display:grid;grid-template-columns:minmax(220px,1.15fr) minmax(170px,.7fr) minmax(150px,.8fr) minmax(108px,auto);gap:12px;align-items:center;border:1px solid var(--dash-border);border-radius:14px;background:#fff;padding:12px;text-align:left}.dash-domain-copy{min-width:220px;word-break:keep-all;overflow-wrap:normal}.dash-domain-copy strong{display:block;font-size:15px;line-height:1.35;word-break:keep-all;overflow-wrap:normal}.dash-domain-copy small{display:block;color:var(--dash-text-secondary);font-size:12px;line-height:1.45;word-break:keep-all;overflow-wrap:normal}.dash-domain-stats{display:flex;gap:7px;flex-wrap:wrap}.dash-domain-stats em{font-style:normal;color:var(--dash-text-secondary);font-size:12px}.dash-dual-bars{display:grid;gap:5px}.dash-dual-bars i,.dash-wide-bar i{display:block;width:var(--w);height:8px;border-radius:999px;background:var(--dash-spec)}.dash-dual-bars .dash-discussion-bar,.dash-wide-bar i{background:var(--dash-discussion)}.dash-thread-card{border:1px solid var(--dash-border);border-radius:16px;background:#fff;padding:16px}.dash-thread-featured{background:linear-gradient(180deg,var(--dash-discussion-soft),#fff 72%);border-color:#ddd6fe}.dash-thread-head{display:flex;justify-content:space-between;gap:10px;align-items:center}.dash-thread-card h3{display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden;margin:10px 0;font-size:16px;line-height:1.4}.dash-thread-metrics{display:grid;gap:3px}.dash-thread-metrics strong{font-size:28px;line-height:1}.dash-thread-metrics strong span{margin-left:5px;font-size:12px;color:var(--dash-text-muted);font-weight:500}.dash-thread-metrics em{font-style:normal;font-size:12px;color:var(--dash-text-secondary)}.dash-wide-bar{height:10px;background:var(--dash-surface-strong);border-radius:999px;margin:12px 0;overflow:hidden}.dash-inline-link{display:inline-flex;align-items:center;gap:4px;color:var(--dash-primary-dark);font-size:12px;font-weight:700}.dash-compact-details{margin-top:14px}.dash-compact-details summary{cursor:pointer;color:var(--dash-text-secondary);font-weight:700}.dash-local-scroll{max-width:100%;overflow-x:auto}.dash-heatmap,.dash-compact-table{min-width:680px;width:100%;border-collapse:collapse}.dash-heatmap th,.dash-heatmap td,.dash-compact-table th,.dash-compact-table td{padding:8px;border-bottom:1px solid var(--dash-border);font-size:12px;text-align:left}.dash-heatmap td{text-align:center}
