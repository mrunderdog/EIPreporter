...
export const ATLAS_DOMAINS: DomainDefinition[] = [
  ...
  },
  {
    ...
    keywords: ["account abstraction", "smart account", "useroperation", "bundler", "session key", "delegation", "delegate", "passkey", "webauthn", "paymaster", "sponsorship", "intent", "wallet", "recovery", "permission"],
    technologies: ["Account Abstraction", "Smart Account", "UserOperation", "Bundler", "Session Key", "Delegation", "Passkey / WebAuthn", "Paymaster", "Intent"],
  },
  {
  ...
  },
  {
    ...
    keywords: ["identity", "credential", "attestation", "allowlist", "eligibility", "restricted transfer", "compliance", "proof", "transfer hook", "privacy-preserving", "kyc"],
    technologies: ["Identity Binding", "Verifiable Credential", "Attestation", "Allowlist / Eligibility", "Restricted Transfer", "Compliance Proof", "Transfer Hook", "Privacy-preserving Credentials"],
  },
  {
    id: "interoperability",
    nameKo: "상호운용성",
...
const TECHNOLOGY_RULES: TechnologyRule[] = [
  ...
  rule("Attestation", "identity-compliance", /\bcredential attestation(s)?\b/i, /\bidentity attestation(s)?\b/i, /\bcompliance attestation(s)?\b/i),
